...
<script>
    ...
    function atualizarResumo() {
        // Agora o home_controller.php retorna um objeto com 'sucesso', 'mensagem' e 'dados'
        $.getJSON('home_controller.php', function(response) {
            if (response.sucesso) {
    ...
    function atualizarGastosMes() {
        ...
        // A requisição para 'gastos_mes' também vai para home_controller.php
        $.ajax({
            url: 'home_controller.php', // O controller que lida com 'gastos_mes' é o home_controller.php
            method: 'GET',
            data: { funcao: 'gastos_mes', ano, mes },
            dataType: 'json',
            success: function(gastos) { // O home_controller.php para 'gastos_mes' retorna diretamente o array de gastos
                let html = '';
    ...
    function excluirGasto(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Requisição vai para o gastos_controller.php, não home_controller.php
