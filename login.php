...
<head>
    ...
    <script type="module">
        ...
        // Lógica de Login (agora via login_controller.php)
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                const data = await $.post('login_controller.php', formData, null, 'json'); // Alterado para 'login_controller.php'
        ...
        // Lógica de Registro (agora via login_controller.php)
